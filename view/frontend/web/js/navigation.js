        ...
        $.widget(
            'gomage.navigation', {
                ...
                _initFilters: function () {
                    ...
                    this._bind(elements);
                    this.options.filters = elements.map(
                ...
                _bind: function (elements) {
                    ...
                    $(this.options.collapsedContainer).on(
                        'click', function () {
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (response) {
                                ...
                                $(this.options.productOlItems).find('.product-item').last().each(
                                    function () {
                ...
                _getParams: function () {
                    ...
                    $(this.options.collapsedContainer).each(
                        function () {
                            if(!collapsedRequest) {
                                if($(this).attr('data-collapsed-filter') == 1) {
